    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const perfilExistente = response.data.some(p => {
                // Si estamos editando, excluir el perfil actual de la comparación
                if (perfil && p.idPerfil === perfil.idPerfil) {
                    return false;
                }
                return p.nombrePerfil.toLowerCase() === formData.nombrePerfil.toLowerCase();
            });
